...
/*Os pontos necessários e importantes dessa atividade é treinar e melhorar a metodologia
para realizar a ordenação de números atráves de um método diferente do Bubble Sort
